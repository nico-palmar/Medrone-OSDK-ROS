...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "3.8.1"
  WORKING_DIRECTORY "/home/nico/catkin_ws/src/Onboard-SDK-ROS/cmake-modules/../Onboard-SDK-3.8.1"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/nico/catkin_ws/src/Onboard-SDK-ROS/cmake-modules/../Onboard-SDK-3.8.1'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/nico/catkin_ws/src/Onboard-SDK-ROS/cmake-modules/../Onboard-SDK-3.8.1'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
